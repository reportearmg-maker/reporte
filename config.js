...
window.RMG_CONFIG = {
  ...
  STORAGE_KEYS: {
    ...
    cacheReportesActivos: 'reporteRmgCacheReportesActivosV34',
    cacheTimestampActivos: 'reporteRmgCacheTimestampActivosV34',
    cacheReportesHistorial: 'reporteRmgCacheReportesHistorialV34',
    cacheTimestampHistorial: 'reporteRmgCacheTimestampHistorialV34'
  },
  rmgBypass: Array.from({ length: 12 }, (_, i) => `RMG ${i + 1}`),
  equipos: [
  ...
  tiposFalla: ['Gantry', 'Hoist', 'Trolley', 'Spreader', 'Micromotion', 'CPS', 'RFID', 'LPS', 'Anti-Lift', 'Cabin Protection', 'Cámaras', 'Mesa Remota / RCS', 'Mantenimiento ING', 'Otros'],
